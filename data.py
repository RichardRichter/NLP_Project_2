...
nonstandard_measurements = ['can', 'stick', 'handful', 'dash', 'to|taste', 'container', 'package', 'loaf', 'slices']
...
cooking_mediums = ['water', 'olive oil', 'butter', 'vegetable oil']
...
mexican_cheese =  [{'name': 'queso fresco', 'type': 'protein', 'quantity': 1, 'measurement': 'package', 'descriptors': ['white'], 'prep': ['broken into pieces']},
{'name': 'queso blanco', 'type': 'protein', 'quantity': 1, 'measurement': 'package', 'descriptors': ['white'], 'prep': ['broken into pieces']},
{'name': 'queso oaxaca', 'type': 'protein', 'quantity': 2, 'measurement': 'ounce', 'descriptors': ['white'], 'prep': ['broken into pieces']}
]
